/**
 * QRCode.js - Robust Client side QR Code generator
 * Auto type-number selection supporting URLs of any length.
 */
var QRCode;
(function () {
    function QR4BitByte(data) {
        this.mode = 4; // 8-bit byte mode
        this.data = data;
    }
    QR4BitByte.prototype = {
        getLength: function () { 
    ...
    // UTF-8 Encoder for QR Byte Mode
    ...
    QRCodeImpl.prototype = {
        addData: function (data) {
            var newData = new QR4BitByte(data);
            newData.parsedData = stringToBytes(data);
    ...
    function QRPolynomial(num, e) {
        if (num.length == undefined) throw new Error(num.length + "/" + e);
        var offset = 0;
        while (offset < num.length && num[offset] == 0) offset++;
        this.num = new Array(num.length - offset + e);
    ...
    // Helper to calculate best type number automatically
    function getBestTypeNumber(sText, errorCorrectLevel) {
        var bytes = stringToBytes(sText);
    ...
    QRCode.prototype.makeCode = function (sText) {
        ...
        var typeNum = getBestTypeNumber(sText, level);
        
        this._oQRCode = new QRCodeImpl(typeNum, level);
